...
This repo contains the Python code and data for the analysis of time-series trends in the predictability of human writings using perplexity and Binoculars measured by OPT-125M, GPT-2, and Llama-3.2.
